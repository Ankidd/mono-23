    ...
    public class Property {
        ...
        public int getRent(){
            ...
            public static List<Property> createProperties() {
                ...
                properties.add(new Property(3,18,(Define.HEIGHT-Define.BIG_TILE_SIZE-Define.SMALL_TILE_SIZE_X*3-12), null, 5000, "CHANCE"));
                ...
                properties.add(new Property(10,Define.BIG_TILE_SIZE+Define.SMALL_TILE_SIZE_X*2,0, Define.LAVENDER_MIST, 5000, "HongKong"));
                ...
                properties.add(new Property(14,Define.BIG_TILE_SIZE+Define.SMALL_TILE_SIZE_X*6,0, null, 5000, "TAX"));
                ...
                properties.add(new Property(17,Define.BIG_TILE_SIZE+Define.SMALL_TILE_SIZE_X*9,0, null, 5000, "CHANCE"));
                properties.add(new Property(18,Define.BIG_TILE_SIZE+Define.SMALL_TILE_SIZE_X*10,0, Define.PASTEL_BLUE, 5000, "Osaka"));
                ...
                properties.add(new Property(24,Define.WIDTH-Define.SMALL_TILE_SIZE_Y+20,(Define.HEIGHT-Define.BIG_TILE_SIZE-Define.SMALL_TILE_SIZE_X*4-12), null, 5000, "TAX"));
                ...
                properties.add(new Property(27,Define.WIDTH-Define.SMALL_TILE_SIZE_Y+20,(Define.HEIGHT-Define.BIG_TILE_SIZE-Define.SMALL_TILE_SIZE_X*1-12), Define.PASTEL_PURPLE, 5000, "Jakarta"));
                ...
                properties.add(new Property(30,Define.WIDTH-Define.BIG_TILE_SIZE-Define.SMALL_TILE_SIZE_X*2,Define.HEIGHT-Define.SMALL_TILE_SIZE_Y, Define.LIGHT_CORAL, 5000, "Mumbai"));
                ...
                properties.add(new Property(32,Define.WIDTH-Define.BIG_TILE_SIZE-Define.SMALL_TILE_SIZE_X*4,Define.HEIGHT-Define.SMALL_TILE_SIZE_Y, Define.LIGHT_PERIWINKLE, 5000, "Cyprus"));
                properties.add(new Property(33,Define.WIDTH-Define.BIG_TILE_SIZE-Define.SMALL_TILE_SIZE_X*5,Define.HEIGHT-Define.SMALL_TILE_SIZE_Y, Define.LIGHT_PERIWINKLE, 5000, "Hamburg"));
                properties.add(new Property(34,Define.WIDTH-Define.BIG_TILE_SIZE-Define.SMALL_TILE_SIZE_X*6,Define.HEIGHT-Define.SMALL_TILE_SIZE_Y, null, 5000, "COMMUNITY CHEST"));
                ...
                properties.add(new Property(36,Define.WIDTH-Define.BIG_TILE_SIZE-Define.SMALL_TILE_SIZE_X*8,Define.HEIGHT-Define.SMALL_TILE_SIZE_Y, Define.PASTEL_BEIGE, 5000, "Milan"));
                ...
                properties.add(new Property(39,Define.WIDTH-Define.BIG_TILE_SIZE-Define.SMALL_TILE_SIZE_X*11,Define.HEIGHT-Define.SMALL_TILE_SIZE_Y, Define.PASTEL_MINT, 5000, "London"));
                properties.add(new Property(40,Define.WIDTH-Define.BIG_TILE_SIZE-Define.SMALL_TILE_SIZE_X*12,Define.HEIGHT-Define.SMALL_TILE_SIZE_Y, Define.PASTEL_MINT, 5000, "Seville"));
                properties.add(new Property(41,Define.WIDTH-Define.BIG_TILE_SIZE-Define.SMALL_TILE_SIZE_X*13,Define.HEIGHT-Define.SMALL_TILE_SIZE_Y, Define.PASTEL_MINT, 5000, "Ahmedabad"));
